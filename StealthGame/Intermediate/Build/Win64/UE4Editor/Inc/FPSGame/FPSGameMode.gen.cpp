...
// End Cross Module References
	...
	void AFPSGameMode::OnMissionCompleted(APawn* InstigatorPawn, bool bHasWon)
	{
	...
	void Z_Construct_UFunction_AFPSGameMode_OnMissionCompleted_Statics::NewProp_bHasWon_SetBit(void* Obj)
	{
		((FPSGameMode_eventOnMissionCompleted_Parms*)Obj)->bHasWon = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AFPSGameMode_OnMissionCompleted_Statics::NewProp_bHasWon = { "bHasWon", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPSGameMode_eventOnMissionCompleted_Parms), &Z_Construct_UFunction_AFPSGameMode_OnMissionCompleted_Statics::NewProp_bHasWon_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFPSGameMode_OnMissionCompleted_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFPSGameMode_OnMissionCompleted_Statics::NewProp_bHasWon,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFPSGameMode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFPSGameMode_OnMissionCompleted, "OnMissionCompleted" }, // 3004695131
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AFPSGameMode, 2606704417);
